...
- Lightweight tests and a GitHub Actions validation workflow; GitHub Pages publishes from `main:/docs`.
...
GitHub Pages publishes the deployment copy from `main:/docs` under a project-specific subdirectory, allowing other static demos to coexist:
